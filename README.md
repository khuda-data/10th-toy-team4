...
우리는 사례에서 확인한 문제가 수집 데이터에서는 어떤 형태로 나타나는지 분석했다. 범위는 수집 시작일인 2026년 8월 3일부터 14일까지의 평일이며, 주말인 8월 8\~9일과 8월 15\~16일, 대체 공휴일인 8월 17일은 제외했다. 8월 18일 데이터는 최종시험용이므로 데이터 누수를 막기 위해 포함하지 않았다.
